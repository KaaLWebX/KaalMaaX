...
tput cup 6 30
echo -e "\x1b[42m ƘɑɑL ШєɞX Channel Created By Kaal \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Are You Subscribe My Channel For Hacking Tutorial (y/n)? \e[m "
read answer
...
tput cup 20 0
figlet -f slant "ƘɑɑL ШєɞX" |lolcat
echo " "
echo " "
#done setting up
