...
echo " "
echo " "
echo -e "\e[33mEnter Your Banner Name(e.g. Kaal or KaaL MaaX) \e[32m \n\n"
read varbanner

echo " " 

echo "toilet -f slant '           $varbanner'  -F gay | lolcat" > kaal-ban.txt

echo -e "\e[33mEnter Your Terminal Name(e.g. root@kaal) \e[32m  \n\n"
read varterm
