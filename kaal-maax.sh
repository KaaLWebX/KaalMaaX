...
#        PROJECT: KaalMaaX            #
#        Author: KAAL (@IamKaaL)       #
#  email: kaalneverdie@gmail.com   #
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO KAAL WEBX TOOLS  \e[m "
echo
#Installing the following packages to install KaalMaaX
echo " "
echo -e "\e[32m[*]\e[34m Installing KaalMaaX \e[m "
echo
#storage permission
termux-setup-storage -y && rm -rf KaalMaaX-master
...
echo "
        ...
        WELCOME TO KAAL WEBX TOOLS_-^^KAAL WEBX^^-_ SUBSCRIBE YOUTUBE+TELEGRAM CHANNEL
...
echo " "
echo "[*]Installing KaalMaaX please wait " |lolcat
sleep 3
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY KAAL WEBX\e[m "
echo -e "\033[1;33m[*]setting termux as a real hacker \e[m"
echo -e "\033[1;33m[*]Please SUBSCRIBE KAAL WEBX channel for hacking tutorial! \e[m "
echo FINISHED !
echo -e "\033[1;32m                                                             
﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌ \033[m "
sleep 4.0
...
echo -e "\e[32m     
    ...
    SUBSCRIBE KAAL WEBX channel for hacking and cyber security tutorials,ok?
...
tput cup 6 30
echo -e "\x1b[42m KAAL WEBX CHANNEL \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Are You Subscribe My Channel For Best Hacking Tutorials (y/n)? \e[m "
read answer
...
tput cup 20 0
figlet -f slant "ƘÁÃL ШÉßX CREATED BY KAAL" |lolcat
echo " "
echo " "
#done setting up
